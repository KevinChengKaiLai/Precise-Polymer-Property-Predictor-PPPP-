...
## **🏆 Benchmark: Kaggle 2025 Open Polymer Competition**

The **run\_on\_Kaggle.ipynb** inference kernel is engineered to operate within the strict constraints of the **NeurIPS 2025** competition leaderboard.
